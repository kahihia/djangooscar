...
class CheckoutSessionMixin(object):
    ...
    def check_payment_data_is_captured(self, request):
        """
        kamper: payment details 페이지에 data를 저장하는 장소
        :param request:
        :return:
        """
        ...
        # if self.checkout_session.is_billng
        pass
    ...
    def build_submission(self, **kwargs):
        ...
        payment_kwargs: paypal or alipay
        ...
        payment_detail_method = self.checkout_session.get_payment_detail_method()
        ...
        submission = {
            ...
            'order_total': total,
            'order_kwargs': {},
            'payment_kwargs': {'method':payment_detail_method}}

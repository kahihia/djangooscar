...
from .models import WirelessReservation


class WirelessReservationForm(forms.ModelForm):
    class Meta:
        model = WirelessReservation
        fields = ['user_name', 'user_email', 'meet_place', 'meet_date', 'meet_time', 'recommended_user_email']
